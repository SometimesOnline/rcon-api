...
class PalworldMessageController(private val messageService: PalworldMessageService) {
    @MessageMapping("/connect")
    @Throws(IOException::class)
    fun connectRcon(
        socketCreateVO: SocketCreateVo,
        headerAccessor: SimpMessageHeaderAccessor
    ): MessageResponseVo<String> {
    ...
    companion object {
        private val log: Logger = LoggerFactory.getLogger(PalworldMessageController::class.java)
    }
}
